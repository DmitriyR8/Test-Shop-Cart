...
class ShippingController extends AdminController
{
    ...
    {
        return Admin::grid(Shipping::class, function (Grid $grid) {
            $grid->id('ID')->sortable();
    ...
    {
        return Admin::show(Shipping::findOrFail($id), function (Show $show) {
            $show->id('id');
            $show->title('title');
            $show->price('price');
    ...
    {
        return Admin::form(Shipping::class, function (Form $form) {
